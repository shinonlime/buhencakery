<x-app-layout>
    ...
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-2 mt-4">
                    ...
                    <a href="/produk/{{ $product->slug }}" class="text-decoration-none text-black">
                        <div class="card shadow h-100" style="width: 18rem">
                            <div style="height: 150px; overflow:hidden;">
                                <img src="{{ asset('storage/'.$product->gambar) }}" class="card-img-top" alt="..." style="object-position: 0px -60px;">
                            </div>
                            <div class="card-body">
                                <h5 class="card-title">{{ $product->nama }}</h5>
                                <h6 class="card-title">Rp{{ number_format($product->harga, 0, ',', '.') }}</h6>
